...
<link rel="stylesheet" href="/JspStudy_4084/static/css/mypage.css">
</head>
<body>
	<div id="container">
		<div class="mypage-items">
		<form action="/JspStudy_4084/profile/update/password" method="post">
			<table>
				<tr>
					<td>이전 비밀번호 확인</td>
	...
	<script type="text/javascript" src="/JspStudy_4084/static/js/password-update.js"></script>
</body>
</html>